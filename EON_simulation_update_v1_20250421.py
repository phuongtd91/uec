...
if __name__ == "__main__":  
    ...
    network = EON_Clos_Network(num_w_switches=4, num_s_switches=4, 
                               num_ports_per_switch=4, spectrum_slots=30)

    print(f' - Spectrum slots in a link: {network.spectrum_slots}')  
    traffic_file=r"E:\Phuongtd@UEC\EON\traffic_jpn12_40.txt"
    ...
    if network.total_requests > 0:  
        print(f"Avg block probability: {network.blocked_requests / network.total_requests * 100:.4f} %")  
    else:  
